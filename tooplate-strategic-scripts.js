...
document.addEventListener('DOMContentLoaded', () => {
   ...
   if (headline && paragraph) {
      ...
      const textSets = [{
            h1: "Expert Consulting.<br>Real-World Results.",
            p: "SRN Solutions Inc. is a Vancouver-based consultancy delivering specialized expertise in Telecom, Recruitment, and IT Consulting — backed by 25 years of hands-on delivery experience."
         },
         {
            h1: "Telecom Expertise.<br>Delivered.",
            p: "From BSS/OSS modernization to CRM integration and cloud-native transformation, we've led carrier-grade programs for Tier-1 clients across North America and beyond."
         },
         {
            h1: "The Right Talent.<br>At the Right Time.",
            p: "We place specialized professionals across Telecom, IT, energy, and professional services — with a niche depth that generalist firms simply can't match."
         }
      ];
